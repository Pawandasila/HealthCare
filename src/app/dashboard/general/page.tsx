...
const HealthConsultationChat: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome-message",
      text: "Hello! I'm your general health assistant. How can I help you today?",
      sender: "ai",
      timestamp: new Date(),
    },
  ]);
  ...
  const quickQuestions: QuickQuestion[] = [
    { id: "q1", text: "What foods should I avoid for general health?" },
    { id: "q2", text: "How can I improve my sleep quality?" },
    { id: "q3", text: "When should I see a doctor for symptoms?" },
    { id: "q4", text: "What exercise routine is good for me?" },
  ];
      ...
      <div className="p-3 bg-card border-t border-border">
        <div className="flex items-center bg-background rounded-full overflow-hidden pl-3 pr-3 py-2 border border-input">
          <input
            ...
            placeholder="Type your general health question here..."
